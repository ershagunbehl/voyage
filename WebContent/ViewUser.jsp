			...
			<div class="top-header" id="header">
				...
				<div class="top-header-left">
					<ul>
						...
						<li><a href="LogoutServlet"><span> </span> Log Out</a></li>
			...
			<div class="header">
				...
				<div class="top-nav">
						<ul class="flexy-menu thick orange">
							...
							<li><a href="index - Copy.html">MY PROFILE</a></li>
		            ...
		            <div class="slide"> 
		                ...
		                <div class="slide_content">
		                    <div class="slide_content_wrap">
		                        <!-- Text title -->
		                        <h4 class="title"> WELCOME TO VOYAGE</h4>
		                        <!-- /Text title -->
		                        <!-- Text description -->
		                        <p class="description">HELLO "${param.fn}"
		                      	<BR>"  ${newatt}"</p>
		                        <!-- /Text description -->
			...
			<div class="wrap">
				...
				<div class="p-ww">
					<form>
						...
						<a href="blog.html"><input type="submit" value="Search" onclick="checkrnum()"/></a>
					</form>
				</div>
				<div class="clear"> </div>
			</div>
		        ...
		        <div class="flexslider carousel">
		          <ul class="slides">
		            <li onclick="location.href='#';">
		  	    	   <a href="LocationServlet?value=1"> <img src="images/g1.jpg" />
		  	    	    <!----place-caption-info---->
		  	    	    <div class="caption-info">
		  	    	    	 <div class="caption-info-head">
		  	    	    	 	<div class="caption-info-head-left">
			  	    	    	 	<h4>Goa</h4>
			  	    	    	 	<span>Bonus Extras!!!! </span></a>
		  	    	    	 	</div>
		  	    		 ...
		  	    		 <li onclick="location.href='#';">
		  	    	  <a href="LocationServlet?value=2">  <img src="images/g2.jpg" />
		  	    	    <!----place-caption-info---->
		  	    	    <div class="caption-info">
		  	    	    	 <div class="caption-info-head">
		  	    	    	 	<div class="caption-info-head-left">
		  	    		 ...
		  	    		 <li onclick="location.href='#';">
		  	    	<a href="LocationServlet?value=13"> <img src="images/g3.jpg" />
		  	    	    <!----place-caption-info---->
		  	    	    <div class="caption-info">
		  	    	    	 <div class="caption-info-head">
		  	    	    	 	<div class="caption-info-head-left">
		  	    		 ...
		  	    		 <li onclick="location.href='#';">
		  	    	  <a href="LocationServlet?value=4">  <img src="images/g4.jpg" />
		  	    	    <!----place-caption-info---->
		  	    	    <div class="caption-info">
		  	    	    	 <div class="caption-info-head">
		  	    	    	 	<div class="caption-info-head-left">
		            ...
		            <li onclick="location.href='#';">
		  	    	 <a href="LocationServlet?value=5">   <img src="images/g5.jpg" />
		  	    	    <!----place-caption-info---->
		  	    	    <div class="caption-info">
		  	    	    	 <div class="caption-info-head">
		  	    	    	 	<div class="caption-info-head-left">
		  	    		 ...
		  	    		 <li onclick="location.href='#';">
		  	   <a href="LocationServlet?value=6"> 	    <img src="images/g6.jpg" />
		  	    	    <!----place-caption-info---->
		  	    	    <div class="caption-info">
		  	    	    	 <div class="caption-info-head">
		  	    	    	 	<div class="caption-info-head-left">
		  	    		 ...
		  	    		 <li onclick="location.href='#';">
		  	    	  <a href="LocationServlet?value=7">  <img src="images/g7.jpg" />
		  	    	    <!----place-caption-info---->
		  	    	    <div class="caption-info">
		  	    	    	 <div class="caption-info-head">
		  	    	    	 	<div class="caption-info-head-left">
		  	    		 ...
		  	    		 <li onclick="location.href='#';">
		  	    	  <a href="LocationServlet?value=8">  <img src="images/g8.jpg" />
		  	    	    <!----place-caption-info---->
		  	    	    <div class="caption-info">
		  	    	    	 <div class="caption-info-head">
		  	    	    	 	<div class="caption-info-head-left">
		             ...
		             <li onclick="location.href='#';">
		  	    	 <a href="LocationServlet?value=9">   <img src="images/g9.jpg" />
		  	    	    <!----place-caption-info---->
		  	    	    <div class="caption-info">
		  	    	    	 <div class="caption-info-head">
		  	    	    	 	<div class="caption-info-head-left">
		  	    	 ...
		  	    	 <li onclick="location.href='#';">
		  	    	  <a href="LocationServlet?value=10">  <img src="images/g10.jpg" />
		  	    	    <!----place-caption-info---->
		  	    	    <div class="caption-info">
		  	    	    	 <div class="caption-info-head">
		  	    	    	 	<div class="caption-info-head-left">
		  	    		 ...
		  	    		 <li onclick="location.href='#';">
		  	    	<a href="LocationServlet?value=11">    <img src="images/g11.jpg" />
		  	    	    <!----place-caption-info---->
		  	    	    <div class="caption-info">
		  	    	    	 <div class="caption-info-head">
		  	    	    	 	<div class="caption-info-head-left">
		  	    		 ...
		  	    		 <li onclick="location.href='#';">
		  	    	  <a href="LocationServlet?value=12">  <img src="images/g12.jpg" />
		  	    	    <!----place-caption-info---->
		  	    	    <div class="caption-info">
		  	    	    	 <div class="caption-info-head">
		  	    	    	 	<div class="caption-info-head-left">
