							...
							<div class="criuse-grid">
										...
										<div class="criuse-pic-info">
												<div class="criuse-pic-info-top">
													...
													<div class="criuse-pic-info-top-place-name">
														<h2><label>${myatt.location}</label><span><p>${myatt.type}</p></span></h2>
													</div>
												</div>
								...
								<div class="criuse-grid-info">
									...
									<p>${myatt.description}</p>
										...
										<!----//select hereeeeeeee---->
										<form name="buttonform" action="LocationServlet">
	...
	<input type="submit" value="Search" />
		...
		<div class="subfooter">
			<div class="wrap">
				...
				<p class="copy-right">Product of <a href="http://w3layouts.com/">Voyage Travels</a></p>
